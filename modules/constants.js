...
export const APP_VERSION = '3.9.87';
export const LAST_SEEN_VERSION_KEY = 'arbeitszeit_last_seen_version';

/* Changelog: keep newest on top. Shown once per new version. */
export const CHANGELOG = [
  { version: '3.9.87', items: [
    'Doku: Bedienungsanleitung (Abschnitt 6a) um Beschreibung des in v3.9.86 eingeführten Urlaubsplanung-Kalenders ergänzt — Farbmarkierungen, Legende, Monats-Navigation und Standardmonat',
  ]},
  ...
  { version: '3.9.77', items: [
    'Geändert: Das Jahr-Feld in den Reitern „Gleitzeitkonto“ und „Urlaubsplanung“ ist jetzt ein Pulldown statt eines Zahlenfelds — zur Auswahl stehen alle Jahre mit vorhandenen Einträgen oder Anstellungszeiträumen sowie das aktuelle und das kommende Jahr',
  ]},
  ...
  { version: '3.9.69', items: [
    ...
    'Regression: 20 neue Checks zum Backup-Ordner (Unterstützungs-Erkennung, IndexedDB-Speicherung, Berechtigungs-Abfrage, Datei-Schreibvorgang, alle UI-Zustände, Integrationstest über echten Export)',
  ]},
  ...
  { version: '3.9.64', items: [
    'Fix: CI-Job "Visual-Regression" wich auf dem GitHub-Actions-Runner trotz identischer Schrift noch minimal ab (0.4–0.9 % Sub-Pixel-Antialiasing durch abweichendes Font-Hinting). Fix: Chromium startet für die Tests jetzt mit --font-render-hinting=none, --disable-font-subpixel-positioning, --disable-lcd-text; Toleranz auf 1 % angehoben; Baselines neu erzeugt',
  ]},
  ...
  { version: '3.9.38', items: [
    ...
    'Summary-Karte oben: Jahresanspruch (inkl. Resturlaub Vorjahr), bereits genommen, eingegeben (Zukunft) und noch nicht erfasst — Jahr frei wählbar',
    'Regression: 28 neue Assertions für computeYearlyVacationPlanning, buildVacationPlanningHTML und die neue Ansicht (132/132 Checks OK)',
  ]},
  ...
  { version: '3.9.36', items: [
    ...
    'Zusammenfassungs-Hinweis nach dem Anlegen: Anzahl angelegter Tage + übersprungene Tage (Wochenende/Feiertag bzw. bereits belegt)',
    'Regression: 6 neue Assertions für die Zeitraum-Erfassung (Wochenend-/Feiertags-Filter, Schutz bestehender Einträge, Monatsbericht-Integration)',
  ]},
  ...
  { version: '3.9.33', items: [
    ...
    'PDF: "Erstellt am" wandert nach unten vor die Unterschriftszeilen',
    '7 neue Regressions-Assertions für das neue PDF-Layout',
  ] },
